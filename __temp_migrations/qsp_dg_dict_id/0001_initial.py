    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='qsp_dg_dict_id_group', to='otree.Session')),
            ],
            options={
                'db_table': 'qsp_dg_dict_id_group',
            },
        ),
        migrations.CreateModel(
            name='Subsession',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('round_number', otree.db.models.PositiveIntegerField(db_index=True, null=True)),
                ('session', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='qsp_dg_dict_id_subsession', to='otree.Session')),
            ],
            options={
                'db_table': 'qsp_dg_dict_id_subsession',
            },
        ),
        migrations.CreateModel(
            name='Player',
            fields=[
                ...
                ('chooseID', otree.db.models.StringField(choices=[('rzxw4', 'rzxw4'), ('wxzr4', 'wxzr4'), ('zrwx4', 'zrwx4')], max_length=10000, null=True, verbose_name='Please choose one of the following IDs.')),
                ('attn_check_1', otree.db.models.IntegerField(blank=True, choices=[[1, 'Cat'], [2, 'Dog'], [3, 'Bird']], default=0, null=True, verbose_name='Please select the word "Dog"')),
                ...
                ('group', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='qsp_dg_dict_id.Group')),
                ('participant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='qsp_dg_dict_id_player', to='otree.Participant')),
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='qsp_dg_dict_id_player', to='otree.Session')),
                ('subsession', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='qsp_dg_dict_id.Subsession')),
            ],
            options={
                'db_table': 'qsp_dg_dict_id_player',
            },
        ),
        migrations.AddField(
            model_name='group',
            name='subsession',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='qsp_dg_dict_id.Subsession'),
        ),
    ]
