# Generated by Django 2.2.4 on 2020-06-29 14:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='qcp_demographics_group', to='otree.Session')),
            ],
            options={
                'db_table': 'qcp_demographics_group',
            },
        ),
        migrations.CreateModel(
            name='Subsession',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('round_number', otree.db.models.PositiveIntegerField(db_index=True, null=True)),
                ('session', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='qcp_demographics_subsession', to='otree.Session')),
            ],
            options={
                'db_table': 'qcp_demographics_subsession',
            },
        ),
        migrations.CreateModel(
            name='Player',
            fields=[
                ...
                ('group', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='qcp_demographics.Group')),
                ('participant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='qcp_demographics_player', to='otree.Participant')),
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='qcp_demographics_player', to='otree.Session')),
                ('subsession', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='qcp_demographics.Subsession')),
            ],
            options={
                'db_table': 'qcp_demographics_player',
            },
        ),
        migrations.AddField(
            model_name='group',
            name='subsession',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='qcp_demographics.Subsession'),
        ),
    ]
