    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inferred_income', otree.db.models.StringField(choices=[('less than $20,000', 'less than $20,000'), ('$20,000 - $40,000', '$20,000 - $40,000'), ('$40,000 - $60,000', '$40,000 - $60,000'), ('$60,000 - $80,000', '$60,000 - $80,000'), ('$80,000 - $100,000', '$80,000 - $100,000'), ('More than $100,000', 'More than $100,000')], max_length=10000, null=True, verbose_name='')),
