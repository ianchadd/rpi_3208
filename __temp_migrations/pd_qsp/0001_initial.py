    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('decision_first', otree.db.models.StringField(choices=[['A', 'A'], ['B', 'B']], max_length=10000, null=True, verbose_name='I choose')),
                ('decision_second', otree.db.models.StringField(choices=[['A', 'A'], ['B', 'B']], max_length=10000, null=True, verbose_name='I choose')),
