...
class Constants(BaseConstants):
    name_in_url = 'qsp_dg_dict_id'
    own_ID = 'qsp_dg_dict_id/own_ID.html'
    other_ID = 'qsp_dg_dict_id/other_ID.html'
    q_title = 'qsp_dg_dict_id/q_title.html'
    both_IDs = 'qsp_dg_dict_id/both_IDs.html'
